...
export default async function HomePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-20 space-y-16 sm:space-y-24 overflow-x-hidden">
      {/* ============================================================ */}
      ...
      <div>
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          <h1 className="text-2xl sm:text-4xl lg:text-[40px] font-bold text-[#0F172A] leading-snug sm:leading-tight">
            {t('titleLine1')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 max-w-4xl mx-auto w-full">
          ...
          <div className="rounded-[24px] sm:rounded-[28px] p-6 sm:p-8 bg-gradient-to-br from-[#E8F1F5] to-[#D4E6F1] border border-[#BEE3F8] shadow-[0_4px_24px_rgba(124,165,184,0.12)] flex flex-col justify-between transition-transform duration-200 hover:-translate-y-1">
            ...
            <div className="mt-6 sm:mt-8 pt-2 sm:pt-4">
              <Link href="/projects/create" className="block">
                <Button
                  ...
                  size="lg"
                  fullWidth
                  className="bg-white hover:bg-[#FAF9F6] text-[#0F172A] border-white/80 shadow-xs font-semibold min-h-[48px]"
                >
          ...
          <div className="rounded-[24px] sm:rounded-[28px] p-6 sm:p-8 bg-gradient-to-br from-[#EDE9FE] to-[#E0E7FF] border border-[#DDD6FE] shadow-[0_4px_24px_rgba(167,139,250,0.12)] flex flex-col justify-between transition-transform duration-200 hover:-translate-y-1">
            <div className="space-y-4">
